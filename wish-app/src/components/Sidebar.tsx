  ...
  return (
    <aside className="w-65 bg-bg-secondary border-r border-border mt-[20px] min-h-[calc(100vh-64px)] rounded-br-xl gap-5 hidden lg:flex flex-col">
      ...
      <div className="p-6 border-b border-border">
        ...
        <p className="text-xs text-text-muted mt-1">Manage your content</p>
      </div>
      ...
      <div className="p-4 border-t border-border">
        <Link
          href="/browse"
          className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm text-text-muted hover:text-white hover:bg-white/5 transition-all duration-300"
        >
